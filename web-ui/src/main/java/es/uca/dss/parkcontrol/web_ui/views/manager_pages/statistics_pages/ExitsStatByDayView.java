...
@Route(value = "/manager/exits-stat-by-day")
@PageTitle("Exits Statistic By Day")
public class ExitsStatByDayView extends VerticalLayout {
    ...
    public ExitsStatByDayView() {
        addClassName("exits-stat-by-day-view");

        requestFactory.setHttpClient(httpClient);
        restTemplate.setRequestFactory(requestFactory);

        add(new H1("Exits Statistic By Day"));
        ...
        showButton.addClickListener(e -> {
            ...
            if (selectedParking != null && selectedDate != null) {
                List<Record> records = Arrays.asList(restTemplate.getForObject("http://localhost:8080/api/v1/managers/parking/" + selectedParking.getId() + "/statistics/exits?dayDate=" + selectedDate.atStartOfDay().format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")), Record[].class));
