...
@Route(value = "/manager/exits-stat-by-month")
@PageTitle("Exits Statistic By Month")
public class ExitsStatByMonthView extends VerticalLayout {
    ...
    public ExitsStatByMonthView() {
        addClassName("exits-stat-by-month-view");

        requestFactory.setHttpClient(httpClient);
        restTemplate.setRequestFactory(requestFactory);

        add(new H1("Exits Statistic By Month"));
        ...
        Button showButton = new Button("Show Exits");
        showButton.addClickListener(e -> {
            ...
            if (selectedParking != null && selectedMonth != null) {
                List<Record> records = Arrays.asList(restTemplate.getForObject("http://localhost:8080/api/v1/managers/parking/" + selectedParking.getId() + "/statistics/exits?monthDate=" + selectedMonth.atDay(1).atStartOfDay().format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")), Record[].class));
